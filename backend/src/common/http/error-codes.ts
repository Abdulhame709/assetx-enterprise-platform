...
export const ERROR_CODES: Record<string, { http: number; code: string }> = {
  ...
  CATEGORY_CYCLE:            { http: 409, code: 'CONFLICT' },
  ...
  LOCATION_TYPE_NOT_FOUND:   { http: 404, code: 'NOT_FOUND' },
  DUPLICATE_LOCATION_TYPE_CODE: { http: 409, code: 'CONFLICT' },
  DUPLICATE_LOCATION_TYPE_NAME: { http: 409, code: 'CONFLICT' },
  LOCATION_TYPE_HAS_LOCATIONS: { http: 409, code: 'CONFLICT' },
  LOCATION_TYPE_CODE_INVALID: { http: 400, code: 'VALIDATION_ERROR' },
  LOCATION_TYPE_NAME_EN_INVALID: { http: 400, code: 'VALIDATION_ERROR' },
  LOCATION_TYPE_ICON_INVALID: { http: 400, code: 'VALIDATION_ERROR' },
  LOCATION_TYPE_SORT_INVALID: { http: 400, code: 'VALIDATION_ERROR' },
